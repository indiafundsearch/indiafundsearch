...
const INDIAN_MINIMUMS: Corridor["sources"] = [
  ...
  {
    label:
      'SEBI (Alternative Investment Funds) Regulations, 2012 — minimum ₹1 crore, investors may be "Indian, foreign or non-resident Indians"',
  ...
  {
    label:
      "IFSCA (Fund Management) Regulations, 2025 — GIFT City scheme minimums and eligible investors",
    url: "https://ifsca.gov.in/Pages/Contents/Fund_Management",
  },
  {
    label:
      "RBI Master Direction — Foreign Investment in India (FEMA non-debt instruments)",
...
export const CORRIDORS: Corridor[] = [
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    related: [
      {
        label: "US tax on Indian investments: the whole map",
        href: "/us-tax",
      },
      {
        label: "Who must file Form 8621",
        href: "/us-tax/form-8621-filing-requirements",
      },
      {
        label: "How PFIC gains are taxed",
        href: "/us-tax/pfic-tax-rate",
      },
      {
    ...
    lede: "Most pages written for US-based NRIs start at the wrong end. They list Indian products, then add a line at the bottom about checking with your CPA. That order is backwards. If you file in America, it is the American tax code that decides what is sensible for you to own. So we start there.",
    facts: [
      [
        "Who this catches",
        "US tax residents — green card or substantial presence",
      ],
      [
        "Indian-side restriction",
        "None — SEBI and IFSCA impose no residency bar",
      ],
      ["Real restriction", "US securities law and the PFIC regime"],
      [
        "Treaty relief on gains",
        "None — the treaty leaves gains to domestic law",
      ],
    ...
    qas: [
      {
        ...
        sources: [
          {
            label: "IRC §7701 — definition of resident alien",
      ...
      },
      {
        ...
        sources: [
          {
            label: "IRC §1297 — PFIC definition",
            url: "https://www.law.cornell.edu/uscode/text/26/1297",
          },
          {
            label: "IRC §1291 — the default excess-distribution regime",
            url: "https://www.law.cornell.edu/uscode/text/26/1291",
          },
          {
            label: "IRC §6501(c)(8) — limitation period does not begin",
            url: "https://www.law.cornell.edu/uscode/text/26/6501",
          },
          {
            label: "Instructions for Form 8621 (Rev. December 2025)",
            url: "https://www.irs.gov/pub/irs-pdf/i8621.pdf",
          },
          {
            label: "IRS quarterly interest rates",
      ...
      },
      {
        ...
        sources: [
          {
            label:
              "SEBI (Portfolio Managers) Regulations, 2020 — Reg. 24(15), securities not held in the manager's name",
            url: "https://www.sebi.gov.in/legal/regulations/sep-2025/securities-and-exchange-board-of-india-portfolio-managers-regulations-2020-last-amended-on-september-03-2025-_96560.html",
          },
        ],
      },
      {
        ...
        sources: [
          {
            label: "Treas. Reg. §301.7701-3 — entity classification election",
            url: "https://www.law.cornell.edu/cfr/text/26/301.7701-3",
          },
          {
            label: "Treas. Reg. §301.7701-2(b)(8) — per-se corporation list",
            url: "https://www.law.cornell.edu/cfr/text/26/301.7701-2",
          },
          {
            label:
              "IRC §1298(a)(3) — indirect ownership through a partnership or trust",
            url: "https://www.law.cornell.edu/uscode/text/26/1298",
          },
        ],
      },
      {
        ...
        sources: [
          {
            label: "India–US tax treaty, full text (IRS)",
            url: "https://www.irs.gov/pub/irs-trty/india.pdf",
          },
          {
            label: "IRC §1411 — net investment income tax",
      ...
      },
      {
        ...
        sources: [
          {
            label: "17 CFR 230.902 — Regulation S definitions",
            url: "https://www.law.cornell.edu/cfr/text/17/230.902",
          },
          {
            label: "Investment Company Act §7(d)",
            url: "https://www.law.cornell.edu/uscode/text/15/80a-7",
          },
        ],
      },
      {
        ...
        sources: [
          ...
          {
            label: "IRS — Summary of FATCA reporting thresholds",
            url: "https://www.irs.gov/businesses/corporations/summary-of-fatca-reporting-for-us-taxpayers",
          },
          {
            label:
              "Bittner v. United States (2023) — per-report, not per-account",
            url: "https://www.law.cornell.edu/supremecourt/text/21-1195",
          },
        ],
      },
      {
    ...
    sources: [
      ...
      {
        label: "IRC §1291 — excess distribution regime",
        url: "https://www.law.cornell.edu/uscode/text/26/1291",
      },
      {
        label: "Instructions for Form 8621 (Rev. December 2025)",
      ...
      {
        label: "IRS — FATCA reporting thresholds",
        url: "https://www.irs.gov/businesses/corporations/summary-of-fatca-reporting-for-us-taxpayers",
      },
      {
        label: "India–US tax treaty (IRS)",
        url: "https://www.irs.gov/pub/irs-trty/india.pdf",
      },
      {
        label: "IRS — Streamlined Filing Compliance Procedures",
  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    related: [
      {
        label: "GIFT City: what it is and who it is for",
        href: "/gift-city",
      },
      {
        label: "How a UAE resident gets a TRC",
        href: "/learn/tax-residency-certificate-uae",
      },
      {
        label: "AIF minimum investment, and who is exempt",
        href: "/learn/aif-minimum-investment",
      },
      {
        label: "Which structure fits — the Fit Finder",
        href: "/fit-finder",
      },
    ],
    marketNote: "If you are tax-resident in the UAE",
    code: "UAE",
    flag: "🇦🇪",
    country: "the UAE",
    ...
    lede: "Most people in Dubai and Abu Dhabi already believe their Indian gains are tax-free. Usually they are right. The question worth asking is what that answer rests on, and what quietly breaks it. Four things do: the certificate, the day count, the structure you picked, and the fact that this reading has only ever been tested at Tribunal level.",
    facts: [
      [
        "UAE tax on your investment income",
        "None — personal investment income is outside corporate tax",
      ],
      [
        "Indian-side restriction",
        "None — SEBI and IFSCA impose no residency bar",
      ...
      [
        "What the treaty position needs",
        "A UAE residency certificate, plus the Indian form",
      ],
      [
        "Day count that matters",
        "183 days in the calendar year — a treaty test, not a UAE one",
      ],
    ...
    qas: [
      {
        ...
        sources: [
          {
            label:
              "UAE Cabinet Decision No. 49 of 2023 — personal investment income excluded",
            url: "https://mof.gov.ae/wp-content/uploads/2023/05/Cabinet-Decision-No.-49-of-2023.pdf",
          },
          {
            label: "Federal Decree-Law No. 47 of 2022 — UAE corporate tax",
            url: "https://mof.gov.ae/wp-content/uploads/2022/12/Federal-Decree-Law-No.-47-of-2022-EN.pdf",
          },
          {
            label: "UAE Ministry of Finance — taxes in the UAE",
            url: "https://mof.gov.ae/en/public-finance/tax/",
          },
        ],
      },
      {
        ...
        sources: [
          {
            label: "UAE Federal Tax Authority — Tax Residency Certificate",
      ...
      },
      {
        ...
        sources: [
          ...
          {
            label:
              "FTA Tax Procedures Guide — Tax Resident and TRC (October 2024)",
      ...
      },
      {
        ...
        sources: [
          {
            label: "DCIT v. K.E. Faizal, ITAT Cochin, ITA 423/Coch/2018 (2019)",
            url: "https://indiankanoon.org/doc/16452218/",
          },
          {
            label:
              "Saket Kanoi v. DCIT, ITAT Delhi, ITA 3243/Del/2023 (October 2024) — full order",
            url: "https://itat.gov.in/public/files/upload/1730272384-j3YKhE-1-TO.pdf",
          },
          {
            label:
              "India's MLI position, OECD — India–UAE listed as a covered agreement",
            url: "https://www.oecd.org/content/dam/oecd/en/topics/policy-sub-issues/beps-mli/beps-mli-position-india.pdf",
          },
        ],
      },
      {
    ...
    sources: [
      {
        label:
          "UAE Cabinet Decision No. 49 of 2023 — personal investment income",
        url: "https://mof.gov.ae/wp-content/uploads/2023/05/Cabinet-Decision-No.-49-of-2023.pdf",
      },
      {
        label: "UAE Cabinet Decision No. 85 of 2022 — tax residency",
        url: "https://tax.gov.ae/Datafolder/Files/Legislation/Corporate%20Tax/Cabinet%20Decision%2085%20of%202022%20-%20For%20publishing.pdf",
      },
      {
        label: "UAE Federal Tax Authority — TRC issuance",
        url: "https://tax.gov.ae/en/services/issuance.of.tax.certificates.aspx",
      },
      {
        label: "DCIT v. K.E. Faizal, ITAT Cochin (2019)",
        url: "https://indiankanoon.org/doc/16452218/",
      },
      {
        label: "Saket Kanoi v. DCIT, ITAT Delhi (2024)",
        url: "https://itat.gov.in/public/files/upload/1730272384-j3YKhE-1-TO.pdf",
      },
      {
        label: "India — Income-tax Act, 2025",
        url: "https://www.incometaxindia.gov.in/income-tax-act-2025",
      },
      ...INDIAN_MINIMUMS,
    ],
  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    related: [
      {
        label: "Which Indian funds hold HMRC reporting fund status",
        href: "/uk-tax/hmrc-reporting-funds-list",
      },
      {
        label: "What UK reporting fund status actually is",
        href: "/uk-tax/uk-reporting-fund-status",
      },
      {
        label: "Reporting vs non-reporting: the rate and the loss relief",
        href: "/uk-tax/reporting-vs-non-reporting-funds",
      },
      {
        label: "What counts as an offshore fund",
        href: "/uk-tax/offshore-reporting-funds",
      },
    ],
    marketNote: "If you are UK-resident and hold Indian investments",
    code: "UK",
    flag: "🇬🇧",
    ...
    lede: "This is the corridor where the quiet losses happen. Nothing goes wrong when you buy, and nothing looks wrong on the statement. The damage shows up years later, when you sell, and a gain you assumed would be taxed at 24% is charged as income instead. Then you find the loss on the one that did not work cannot be set against it.",
    facts: [
      [
        "Decisive question",
        "Does your share class hold HMRC reporting fund status?",
      ],
      [
        "If it does not",
        "Profit taxed as income, up to 45%, no annual exempt amount",
      ],
      [
        "If it does",
        "Capital gains treatment — plus annual tax on excess reported income",
      ],
      [
        "Indian funds on HMRC's list",
        "A small and growing minority, mostly only since April 2025",
      ],
      [
        "Who restricts you",
        "Not the UK, and not India — the provider's own promotion rules",
      ],
    ],
    table: {
    ...
    qas: [
      {
        ...
        sources: [
          {
            label:
              "HMRC Investment Funds Manual IFM13412 — charge to tax on offshore income gains",
            url: "https://www.gov.uk/hmrc-internal-manuals/investment-funds/ifm13412",
          },
          {
            label: "HMRC IFM13550 — losses on non-reporting funds",
            url: "https://www.gov.uk/hmrc-internal-manuals/investment-funds/ifm13550",
          },
        ],
      },
      {
        ...
        sources: [
          {
            label:
              "HMRC — Offshore funds: list of reporting funds (updated monthly)",
            url: "https://www.gov.uk/government/publications/offshore-funds-list-of-reporting-funds",
          },
        ],
      },
      {
        ...
        sources: [
          {
            label: "HMRC IFM12146 — UK investors in reporting funds",
            url: "https://www.gov.uk/hmrc-internal-manuals/investment-funds/ifm12146",
          },
        ],
      },
      {
        ...
        sources: [
          {
            label: "HMRC IFM12220 — definition of an offshore fund",
            url: "https://www.gov.uk/hmrc-internal-manuals/investment-funds/ifm12220",
          },
          {
      ...
      },
      {
        ...
        sources: [
          ...
          {
            label: "HMRC Residence and FIG Regime Manual",
            url: "https://www.gov.uk/hmrc-internal-manuals/residence-and-fig-regime-manual/rfig44000",
          },
          {
            label: "HMRC IFM13414 — offshore income gains and the FIG regime",
            url: "https://www.gov.uk/hmrc-internal-manuals/investment-funds/ifm13414",
          },
        ],
      },
      {
        ...
        sources: [
          {
            label:
              "HMRC HS264 — remittance basis and the Temporary Repatriation Facility",
            url: "https://www.gov.uk/government/publications/remittance-basis-hs264-self-assessment-helpsheet/hs264-remittance-of-pre-6-april-2025-foreign-income-and-gains-and-the-temporary-repatriation-facility-trf",
          },
          {
            label: "HMRC RDRM73400 — TRC designation",
            url: "https://www.gov.uk/hmrc-internal-manuals/residence-domicile-and-remittance-basis/rdrm73400",
          },
        ],
      },
      {
        ...
        sources: [
          ...
          {
            label: "HMRC DT9553 — India: tax spared",
            url: "https://www.gov.uk/hmrc-internal-manuals/double-taxation-relief/dt9553",
          },
          {
            label: "HMRC SA106 foreign pages and notes",
      ...
      },
      {
        ...
        sources: [
          {
            label: "HMRC IEIM400090 — CRS participating jurisdictions",
            url: "https://www.gov.uk/hmrc-internal-manuals/international-exchange-of-information/ieim400090",
          },
          {
            label: "GOV.UK — Worldwide Disclosure Facility",
            url: "https://www.gov.uk/guidance/worldwide-disclosure-facility-make-a-disclosure",
          },
          {
            label: "HMRC — territory categorisation for offshore penalties",
            url: "https://www.gov.uk/government/publications/territory-categorisation-for-offshore-penalties/territory-categorisation-for-offshore-penalties-from-24-july-2013",
          },
        ],
      },
      {
        ...
        sources: [
          {
            label: "FSMA 2000 s.21 — restrictions on financial promotion",
            url: "https://www.legislation.gov.uk/ukpga/2000/8/section/21",
          },
          {
            label: "FCA — financial promotions and adverts",
    ...
    sources: [
      {
        label: "HMRC — Offshore funds: list of reporting funds",
        url: "https://www.gov.uk/government/publications/offshore-funds-list-of-reporting-funds",
      },
      {
        label: "HMRC IFM13412 — offshore income gains",
        url: "https://www.gov.uk/hmrc-internal-manuals/investment-funds/ifm13412",
      },
      {
        label: "HMRC IFM12220 — definition of an offshore fund",
      ...
      {
        label: "GOV.UK — the 4-year foreign income and gains regime",
        url: "https://www.gov.uk/guidance/check-if-you-can-claim-the-4-year-foreign-income-and-gains-regime",
      },
      {
        label: "HMRC HS264 — Temporary Repatriation Facility",
        url: "https://www.gov.uk/government/publications/remittance-basis-hs264-self-assessment-helpsheet/hs264-remittance-of-pre-6-april-2025-foreign-income-and-gains-and-the-temporary-repatriation-facility-trf",
      },
      {
        label: "GOV.UK — Worldwide Disclosure Facility",
      ...
      {
        label: "FSMA 2000 s.21 — financial promotion",
        url: "https://www.legislation.gov.uk/ukpga/2000/8/section/21",
      },
      ...INDIAN_MINIMUMS,
    ],
